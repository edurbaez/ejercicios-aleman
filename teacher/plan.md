...
**Estado (2026-07-29): tarea 5 completada** (selector de nivel funcionando para A1/A2/B1, B2/C1/C2 deshabilitados hasta que existan). Tarea 4 para B2 **ya desbloqueada** (mismo día: `plan.js` de B2 verificado completo en la sesión B2.1-B2.4 de `plan.md` raíz) — pendiente solo escribir `teacher/clases-b2.js`. C1/C2 siguen bloqueados. Siguiente pieza natural: `teacher/clases-b2.js`, o 1+2 (edición + persistencia), o 3 (mapeo por fecha de inicio).
